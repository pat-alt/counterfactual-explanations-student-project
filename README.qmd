...
You are free to either follow this recipe exactly or tweak the various parameters that determine the experiemntal design as you see fit. Make sure that you end up running the exact same experiment though, in order for the results to be comparable. 
...
2. research proposal presentations + collective evaluation requirements proposal (Q4 week 2)
